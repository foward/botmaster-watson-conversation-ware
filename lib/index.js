 ...
 *     url: <url_gateway_as_provided_by_bluemix>,
 *     version: '2018-02-16', // latest version-date as of this writing
 *   },
...
const WatsonConversationWare = (options) => {
  ...
  const watson = new watsonDeveloperCloud.AssistantV1(options.settings);
